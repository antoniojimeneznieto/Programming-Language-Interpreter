...
class SymbolTable {
  ...
  // Given a constructor name, searches the symbol table for the correct module name, and returns the pair of it
  def getModuleFromName(name: String): Option[(String, String)] = {
    defsByName.keySet.find((o, n) => name == n)
  }
